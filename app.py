...
UI_TRANSLATIONS = {
    'en': {
        ...
        'thinking': '🌱 Thinking...',
        'footer_title': '🌾 Agrisense AI',
        'footer_tagline': 'Empowering Farmers with Technology',
        'footer_copyright': '© 2025 Agrisense AI. All rights reserved.',
    ...
    'hi': {
        ...
        'footer_title': '🌾 एग्रीसेंस एआई',
        'footer_tagline': 'प्रौद्योगिकी से किसानों को सशक्त बनाना',
        'footer_copyright': '© 2025 एग्रीसेंस एआई। सर्वाधिकार सुरक्षित।',
    ...
    'mr': {
        ...
        'footer_title': '🌾 अ‍ॅग्रीसेन्स एआय',
        'footer_tagline': 'तंत्रज्ञानाद्वारे शेतकऱ्यांना सक्षम करणे',
        'footer_copyright': '© 2025 अ‍ॅग्रीसेन्स एआय. सर्व हक्क राखीव.',
    ...
    'ta': {
        ...
        'footer_title': '🌾 அக்ரிசென்ஸ் AI',
        'footer_tagline': 'தொழில்நுட்பத்துடன் விவசாயிகளை மேம்படுத்துதல்',
        'footer_copyright': '© 2025 அக்ரிசென்ஸ் AI. அனைத்து உரிமைகளும் பாதுகாக்கப்பட்டவை.',
    ...
    'te': {
        ...
        'footer_title': '🌾 అగ్రిసెన్స్ AI',
        'footer_tagline': 'సాంకేతికతతో రైతులను శక్తివంతం చేయడం',
        'footer_copyright': '© 2025 అగ్రిసెన్స్ AI. అన్ని హక్కులూ రక్షించబడ్డాయి.',
    ...
    'bn': {
        ...
        'footer_title': '🌾 অ্যাগ্রিসেন্স AI',
        'footer_tagline': 'প্রযুক্তির সাথে কৃষকদের ক্ষমতায়ন',
        'footer_copyright': '© 2025 অ্যাগ্রিসেন্স AI. সমস্ত অধিকার সংরক্ষিত।',
    ...
    'gu': {
        ...
        'footer_title': '🌾 અ‍ૅગ્રીસેન્સ AI',
        'footer_tagline': 'ટેકનોલોજી સાથે ખેડૂતોને સશક્ત બનાવવા',
        'footer_copyright': '© 2025 અ‍ૅગ્રીસેન્સ AI. બધા અધિકારો અનામત.',
    ...
    'kn': {
        ...
        'footer_title': '🌾 ಅಗ್ರಿಸೆನ್ಸ್ AI',
        'footer_tagline': 'ತಂತ್ರಜ್ಞಾನದೊಂದಿಗೆ ರೈತರನ್ನು ಸಶಕ್ತಗೊಳಿಸುವುದು',
        'footer_copyright': '© 2025 ಅಗ್ರಿಸೆನ್ಸ್ AI. ಎಲ್ಲಾ ಹಕ್ಕುಗಳನ್ನು ಕಾಯ್ದಿರಿಸಲಾಗಿದೆ.',
    ...
    'ml': {
        ...
        'footer_title': '🌾 അഗ്രിസെന്‍സ് AI',
        'footer_tagline': 'സാങ്കേതികവിദ്യയിലൂടെ കർഷകരെ ശാക്തീകരിക്കൽ',
        'footer_copyright': '© 2025 അഗ്രിസെന്‍സ് AI. എല്ലാ അവകാശങ്ങളും സംരക്ഷിതം.',
    ...
    'pa': {
        ...
        'footer_title': '🌾 ਐਗਰੀਸੈਂਸ AI',
        'footer_tagline': 'ਤਕਨਾਲੋਜੀ ਨਾਲ ਕਿਸਾਨਾਂ ਨੂੰ ਸਸ਼ਕਤ ਬਣਾਉਣਾ',
        'footer_copyright': '© 2025 ਐਗਰੀਸੈਂਸ AI. ਸਾਰੇ ਅਧਿਕਾਰ ਰਾਖਵੇਂ.',
...
def get_greeting_by_language(lang_code):
    ...
    greetings = {
        'en': 'Namaste! Welcome to Agrisense AI!',
        'hi': 'नमस्ते! एग्रीसेंस एआई में आपका स्वागत है!',
        'mr': 'नमस्कार! अॅग्रीसेन्स एआय मध्ये आपले स्वागत आहे!',
        'ta': 'வணக்கம்! அக்ரிசென்ஸ் AI-க்கு வரவேற்கிறோம்!',
        'te': 'నమస్కారం! అగ్రిసెన్స్ AI కి స్వాగతం!',
        'bn': 'নমস্কার! অ্যাগ্রিসেন্স AI তে স্বাগতম!',
        'gu': 'નમસ્તે! અ‍ૅગ્રીસેન્સ AI માં તમારું સ્વાગત છે!',
        'kn': 'ನಮಸ್ಕಾರ! ಅಗ್ರಿಸೆನ್ಸ್ AI ಗೆ ಸ್ವಾಗತ!',
        'ml': 'നമസ്കാരം! അഗ്രിസെന്‍സ് AI യിലേക്ക് സ്വാഗതം!',
        'pa': 'ਸਤ ਸ੍ਰੀ ਅਕਾਲ! ਐਗਰੀਸੈਂਸ AI ਵਿੱਚ ਤੁਹਾਡਾ ਸੁਆਗਤ ਹੈ!'
    }
